...
use hawk_core::{dimension_key_from_pairs, DimensionKey, DistributionRepr, Schema, VariableType};
use hawk_storage::Database;

use crate::column_mapper::MappedRow;
...
fn resolve_value(variable: &hawk_core::VariableDefinition, value: &Value) -> Option<SingleDelta> {
